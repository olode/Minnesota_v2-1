                  ...
                  <div class="col-lg-9 col-md-12">
                    <div class="card-body">
                      <ul class="list-inline text-center">
                        <li class="mr-1">
                          <h6><i class="ft-circle amber"></i>
                            <span>iOS</span>
                          </h6>
                        </li>
                        <li class="mr-1">
                          <h6><i class="ft-circle primary"></i>
                            <span>Windows</span>
                          </h6>
                        </li>
                        <li class="mr-1">
                          <h6><i class="ft-circle info"></i>
                            <span>Android</span>
                          </h6>
                        </li>
                      </ul>
              ...
              <div class="card-content">
                <div class="card-body">
                  <ul class="list-inline text-right pr-2">
                    <li>
                      <h6><i class="ft-circle grey lighten-1"></i> Avg. Session Duration
                        </h6>
                    </li>
                    <li>
              ...
              <div class="card-content">
                <div class="card-body text-center">
                  ...
                  <div class="card-content">
                    ...
                    data-inputColor="#e1e1e1" data-readOnly="true" data-fgColor="#FF5722"
        ...
        <div class="row">
              ...
              <div class="card-content">
                ...
                <div class="card-body bg-amber bg-lighten-4">
                  ...
                  <div class="animated-weather-icons text-center">
                    <svg version="1.1" id="wind" class="climacon climacon_wind climacon-amber climacon-darken-2 height-200"
                    viewBox="15 15 70 70">
          ...
          <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="card profile-card-with-cover">
              <div class="card-content">
                <div class="card-img-top img-fluid bg-cover height-200" style="background: url('dashboard/app-assets/images/backgrounds/fb.jpg') 0 40%;"></div>
                <div class="card-profile-image">
                  <img src="{{asset('dashboard/app-assets/images/portrait/small/avatar-s-9.png')}}" class="rounded-circle img-border box-shadow-1"
                  alt="Card image">
                </div>
