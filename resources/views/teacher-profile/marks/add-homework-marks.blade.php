...
<div class="content-detached content-left">
                      ...
                      <div data-repeater-list="car">
                        <div data-repeater-item>
                          <form class="form row">
                            ...
                            <div class="form-group mb-1 col-sm-12 col-md-2">
                              <label for="profession">اختر الواجب </label>
                              <br>
                              <select class="form-control" id="profession">
                                <option>اختر الواجب</option>
                                <option>Option 1</option>
                                <option>Option 2</option>
                                <option>Option 3</option>
                                <option>Option 4</option>
        ...
        <!-- // Form repeater section end -->
          ...
          <section id="description" class="card">
            <div class="card-header">
              <h4 class="card-title">اضافة درجات الواجبات</h4>
            </div>
                ...
                <div class="card-text">
                  ...
                  <table class="table table-responsive table-bordered dataex-html5-selectors">
                      ...
                      <tr>
                          ...
                          <td>٣</td>
                          <td>
                          <input type="text"><a href="{{route('marks.show',1)}}" class="btn btn-success">حفظ</a>
                          </td>
                        </tr>
                        <tr>
                          <td>احمد سعد علي</td>
