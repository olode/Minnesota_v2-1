<div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          ...
          <li class=" nav-item"><a href="{{route('student-profile.index')}}"><i class="icon-home"></i><span class="menu-title" data-i18n="nav.scrumboard.main">الرئيسية</span></a>
            </li>

            <li class=" navigation-header">
              <span data-i18n="nav.category.layouts">الفصول الدراسية والدرجات</span><i class="ft-more-horizontal ft-minus" data-toggle="tooltip"
              data-placement="right" data-original-title="الفصول والدرجات"></i>
            </li>
            <li class=" nav-item"><a href="index.html"><i class="icon-book-open"></i><span class="menu-title" data-i18n="nav.dash.main">عرض</span></a>
              <ul class="menu-content">
              <li ><a class="menu-item" href="{{route('student-semesters')}}" data-i18n="nav.dash.analytics">الفصول الدراسية</a>
                </li>
                <li ><a class="menu-item" href="{{route('student-plan')}}" data-i18n="nav.dash.analytics">الخطة الدراسية</a>
                </li>
                <!-- <li><a class="menu-item" href="dashboard-project.html" data-i18n="nav.dash.project"></a> -->
                </li>
              </ul>
            </li>
