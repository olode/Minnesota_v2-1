              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      <img style="width: 100%; height: 100%;" src="{{asset('dashboard/app-assets/images/logo/login-logo.jpg')}}" alt="شعار الجامعة">
                      <p></p>
                      <p>تسجيل دخول</p>
                    </div>
                  </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal form-simple" action="{{ route('teacher.login.submit') }}" method="POST" novalidate>
                      @csrf
