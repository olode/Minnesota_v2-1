...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('follow_up_homeworks', function(Blueprint $table) {
		...
		Schema::table('follow_up_quizzes', function(Blueprint $table) {
			$table->foreign('student_id')->references('id')->on('quizzes')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
		Schema::table('follow_up_quizzes', function(Blueprint $table) {
		...
		Schema::table('follow_up_final_exams', function(Blueprint $table) {
			$table->foreign('student_id')->references('id')->on('students')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
	...
	public function down()
	{
		...
		Schema::table('student_classes', function(Blueprint $table) {
			$table->dropForeign('student_classes_semester_id_foreign');
		});
		Schema::table('student_classes', function(Blueprint $table) {
		...
		Schema::table('student_classes', function(Blueprint $table) {
			$table->dropForeign('student_classes_year_id_foreign');
		});
		Schema::table('student_marks', function(Blueprint $table) {
		...
		Schema::table('student_marks', function(Blueprint $table) {
			$table->dropForeign('student_marks_year_id_foreign');
		});
		Schema::table('users', function(Blueprint $table) {
		...
		Schema::table('homeworks', function(Blueprint $table) {
			$table->dropForeign('homeworks_lecture_id_foreign');
		});
		Schema::table('homeworks', function(Blueprint $table) {
			$table->dropForeign('homeworks_class_id_foreign');
		});
		Schema::table('homeworks', function(Blueprint $table) {
			$table->dropForeign('homeworks_stage_id_foreign');
		});
		Schema::table('homeworks', function(Blueprint $table) {
			$table->dropForeign('homeworks_section_id_foreign');
		});
		Schema::table('follow_up_homeworks', function(Blueprint $table) {
			$table->dropForeign('follow_up_homeworks_homework_id_foreign');
		});
		Schema::table('follow_up_homeworks', function(Blueprint $table) {
			$table->dropForeign('follow_up_homeworks_student_id_foreign');
		});
		Schema::table('quizzes', function(Blueprint $table) {
			$table->dropForeign('quizzes_class_id_foreign');
		});
		Schema::table('follow_up_quizzes', function(Blueprint $table) {
			$table->dropForeign('follow_up_quizzes_student_id_foreign');
		});
		Schema::table('follow_up_quizzes', function(Blueprint $table) {
			$table->dropForeign('follow_up_quizzes_quizze_id_foreign');
		});
		Schema::table('final_exams', function(Blueprint $table) {
			$table->dropForeign('final_exams_class_id_foreign');
		});
		Schema::table('follow_up_final_exams', function(Blueprint $table) {
			$table->dropForeign('follow_up_final_exams_student_id_foreign');
		});
		Schema::table('follow_up_final_exams', function(Blueprint $table) {
			$table->dropForeign('follow_up_final_exams_final_exam_id_foreign');
		});
	}
}